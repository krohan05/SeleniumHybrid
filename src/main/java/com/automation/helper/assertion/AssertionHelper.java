...
public class AssertionHelper {
	...
	public static void verifyNotEqualText(Object s1, Object s2) {
		// log.info("verifying unequal text: " + s1 + " with " + s2);
	...
	public static void fail(String failureMessage) {
		Assert.assertTrue(false, failureMessage);
	}
	...
	public static void comparePartialText(String fullText, String partialText) {
		log.info("Compare if the partial text is present in the full text");
		Assert.assertTrue(fullText.toLowerCase().contains(partialText.toLowerCase()));
	}
